...
<?php if ($noticiero_query->have_posts()): ?>
  ...
  ?>
    ...
    ?>
     <!-- Slide  -->
     <div class="mix <?php echo esc_attr($classes); ?> item" role="group">

      <article class="card card--bg-dark">
        ...
        <header class="card__media">
          ...
          <div class="card__controls" role="group" aria-label="Compartir en redes sociales">
            <span class="card__btn card__btn--share" aria-label="Compartir">
              Compartir
              <a href="https://www.facebook.com/sharer/sharer.php?u={<?php echo esc_url(get_permalink()); ?>}" class="card__social-link" aria-label="Compartir en Facebook">
