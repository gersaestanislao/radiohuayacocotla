...
?>
    ...
    <section 
      class="carrusel-videos w-section 
      ...
      <div class="owl-carousel owl--news owl--serie owl-theme" aria-label="Carrusel de noticias">

        <!-- Carga del modúlo de card-->
        <?php include('moduls/m-card--video--home.php'); ?>  

      </div>

      <button class="carrusel-videos__controls carrusel-videos__controls--prevVideos" aria-label="Anterior">
        <i class="fa-solid fa-chevron-left"></i>
      </button>

      <button class="carrusel-videos__controls carrusel-videos__controls--nextVideos" aria-label="Siguiente">
        <i class="fa-solid fa-chevron-right"></i>
      </button>
   

      <a href="<?php echo esc_url($link); ?>" class="m-title__btn  m-title__btn--videos btn btn--primary" role="button">
          Todos los videos
      </a>
